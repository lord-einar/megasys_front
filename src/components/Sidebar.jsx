  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 h-16 px-6 border-b border-gray-800">
        ...
        <div>
          <h2 className="text-lg font-bold whitespace-nowrap text-white">Sistema Gestión</h2>
          <p className="text-xs text-gray-400 whitespace-nowrap">Empresarial</p>
        </div>
      </div>
      ...
      <div className="border-t border-gray-800 p-4">
        <div className="flex items-center gap-3 px-2 py-3 rounded-lg bg-gray-800/50 mb-3">
        ...
        <button className="w-full px-4 py-2 bg-gray-800 text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-colors text-sm font-medium flex items-center justify-center gap-2">
