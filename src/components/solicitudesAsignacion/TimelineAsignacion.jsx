// Mapeo de cada acción del historial de asignaciones a label visible y color del punto.
const ACCION_CONFIG = {
...
export default function TimelineAsignacion({ historial = [] }) {
  if (!historial.length) {
    return (
  ...
  // Backend devuelve historial ASC; mostramos el más reciente arriba.
